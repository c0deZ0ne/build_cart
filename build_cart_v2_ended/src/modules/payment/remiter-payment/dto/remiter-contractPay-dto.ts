...
export class RemitterVerifyPaymentRefDto {
  ...
  @IsNotEmpty()
  @ApiProperty({
    example: PaymentType.ACCOUNT_WALLET_TOP_UP,
    enum: PaymentType,
    description: 'Type of payment from the frontend. Accepted values: ACCOUNT_WALLET_TOP_UP, ORDER_PAYMENT, PROJECT_WALLET_TOP_UP',
  })
