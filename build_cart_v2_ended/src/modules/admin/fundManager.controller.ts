...
export class SponsorController {
  ...
  // })
  // @UsePipes(ValidationPipe)
  // @Get('fundManager/:email/projects')
  // async getAllSponsorProjects(@Param('email') email: string): Promise<any> {
  //   const user = await this.userService.getUserByEmailOrThrow(email);
  //   const projects = await this.projectService.getAllProjectsForUser(
  //     user.FundManagerId,
  //     user,
  //   );
