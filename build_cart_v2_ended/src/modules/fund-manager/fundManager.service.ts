...
export class FundManagerService {
  ...
  //   return {
  //     name: userData.name,
  //     companyName: user.FundManager.contactName,
  //     account_number: user.wallet.account_number || null,
  //     address: user.FundManager.address,
  //     phone: user.FundManager.phone || user.FundManager.contactPhone,
  //     logo: user.FundManager.logo,
  //     about: user.FundManager.about,
  //     status: user.status,
  //     email: user.email,
  //     contactEmail: user.FundManager.contactEmail,
  //     contactName: user.FundManager.contactName,
  //     contactPhone: user.FundManager.contactPhone,
  //   };
  // }
