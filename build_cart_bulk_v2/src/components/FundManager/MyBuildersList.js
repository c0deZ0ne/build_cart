...
import { useRetriveMyBuildersQuery } from "../../redux/api/fundManager/fundManager";
...
const MyBuildersList = ({ searchTerm }) => {
  const { data, isLoading, refetch } = useRetriveMyBuildersQuery(searchTerm);
    ...
    <Box>
      <BaseTable
        ...
        empty={
          <EmptyState>
            <Text>
              you have not transacted with any builders yet. When you complete
