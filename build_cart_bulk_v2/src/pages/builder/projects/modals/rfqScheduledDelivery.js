...
const RfqScheduledDelivery = ({
  ...
  const onSubmit = async (data) => {
    ...
    const payload = {
      ...
      requestType: "PUBLIC",
      deliveryContactNumber: rfqData?.deliveryContact,
      // paymentTerns: data?.payment?.value, REVERT BACK LATER IN FUTURE
      paymentTerns: "PAY_ON_DELIVERY",
      tax: true,
      taxPercentage: 5,
  ...
  return (
    <div>
      <Box mb="40px">
        ...
        {/* COMMENT FOR NOW!!! TO BE IMPLEMENTED IN FUTURE */}
        <Box my={"30px"}>
