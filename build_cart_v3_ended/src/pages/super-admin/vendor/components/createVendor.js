...
} from "../../../../redux/api/super-admin/vendorSlice";
...
export default function CreateVendor({ refetch, isOpen, onClose }) {
  ...
  return (
    <>
      <BaseModal
        ...
        title="Create Vendor"
        subtitle="Invite a vendor to the platform."
      >
        {creationSuccessful ? (
          <SuccessMessage message="Vendor created and invited successfully." />
        ) : (
      ...
      <BaseModal
        ...
        subtitle="Enter vendor’s business information."
      >
        {updateSuccess ? (
          <SuccessMessage
            message="Vendor’s business information 
          added successfully."
          />
        ) : (
      ...
      <BaseModal
        isOpen={vendorProfile}
        onClose={() => setVendorProfile(false)}
        title="Vendor Profile"
        subtitle="Enter vendor’s profile details."
      >
        <CreateVendorProfile
