...
const RfqScheduledDelivery = ({ onClose, onCloseRfq, rfqData, builderId }) => {
  ...
  const onSubmit = async (data) => {
    ...
    const payload = {
      projectId: rfqData.projectTitle.value,
      ...
      deliveryContactNumber: rfqData?.deliveryContactNumber,
      ...
      materials: [
        {
          itemName: rfqData?.name?.label,
          specification: rfqData?.specification?.label,
    ...
    try {
      await instance.post(`/superAdmin/builders/${builderId}/rfqs`, payload);
