...
export default function TermOfUseVendor({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      <ModalOverlay />
      <ModalContent>
        <ModalHeader color={"#211F5C"}>TERMS OF USE OF THE WEBSITE</ModalHeader>
        <ModalCloseButton />
        <ModalBody>
          <Stack id={"bottom-level"}>
            ...
            <Text>
              ...
              you, (referenced as “you”, “your”) the buyer of products through
              our website: livevend.com (“Website”). <br /> <br />
            ...
            <Text ml={2}>
              ...
              solutions in the construction and real estate industry through the
              Website.
            </Text>
            <br />
            <Text color={"#211F5C"} fontWeight={"bold"}>
            ...
            <Box ml={3}>
              ...
              <Box ml={3}>
                ...
                <Text ml={2}>
                  ...
                  is truthful and accurate and you will maintain the accuracy of
                  such information.
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
            ...
            <Box ml={3}>
              ...
              <Text ml={2}>
                ...
                personal information, and you shall bear all responsibility for
                any breach, illegal access, loss and/or corruption of such data.
              </Text>
              <Text ml={2}>
                <Text as={"span"} color={"#F5862E"}>
                  3.3
                </Text>{" "}
                Cutstruct makes no representations or warranties whatso ever in
                respect of the information provided on the Website. Information
                may be provided by third parties, including vendors and other
                users of the Website. We cannot accept any liability whatsoever
                in respect of any such content which is provided by third
                parties and other users of the Website.
              </Text>
              <Text ml={2}>
                <Text as={"span"} color={"#F5862E"}>
                  3.4
            ...
            <Box ml={3}>
              ...
              <Box ml={3}>
                ...
                <Text ml={2}>
                  ...
                  you will immediately notify us in writing if you become aware
                  of any disclosure of your account details.
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
                    5.1.3
                  </Text>{" "}
                  you will be fully responsible for any activity conducted on
                  the Website as a result of a disclosure of your account
                  details.
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
                  ...
                  liability arising from the assignment of your account to a
                  third party.
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
                  ...
                  use or access another vendor’s account.
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
                    5.1.6
                  ...
                  vendor on and users of the Website.
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
                    5.1.7
                ...
                <Text ml={2}>
                  ...
                  illegal, fraudulent, or unauthorized; or further such
                  activity, or that involves (or you reasonably believe or
                  should reasonably believe to involve) any stolen, illegal,
                ...
                <Text ml={2}>
                  ...
                  You will not publish falsehoods or misrepresentations on and
                ...
                <Text ml={2}>
                  ...
                  you will not conduct yourself in a manner that will cause you
                  to receive negative ratings and reviews on the Website.
                  (including material promoting or glorifying hate, violence, or
                  bigotry or otherwise inappropriate to the community ethos of
                  Cutstruct).
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
                ...
                <Text ml={2}>
                  ...
                  community ethos of Cutstruct).
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
                    5.1.13
                  </Text>{" "}
                  you will not collect or mine data relating to other users of
                  the Website.
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
              ...
              <Text ml={2}>
                ...
                law enforcement authorities in prosecuting anyone involved with
                such violations.
              </Text>
              <Text ml={2}>
                <Text as={"span"} color={"#F5862E"}>
                ...
                sole discretion. Specifically, no waiver of any breach or
                default hereunder shall be deemed tobe a waiver of any preceding
                or subsequent breach or default. Nothing contained in this
                Agreement shall be construed to limit the actions or remedies
                available to us with respect to any prohibited activity or
                conduct.
              </Text>
              <Text ml={2}>
                <Text as={"span"} color={"#F5862E"}>
              ...
              <Text ml={2}>
                ...
                You may delete your account with us provided that you duly
                notify us of same by sending the notice to
                support@cutstruct.com.
              </Text>
            </Box>
            ...
            <Box ml={3}>
              <Text ml={2}>
                ...
                It will be your responsibility to list your products and
                materials on the Website, and will in this regard, include the
                price, detailed specifications, information and images of the
                products.
              </Text>
              <Text ml={2}>
                <Text as={"span"} color={"#F5862E"}>
              ...
              <Box ml={3}>
                <Text ml={2}>
                  ...
                  you will procure all licenses as may be required for the sale
                  of your products on the Website.
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
                    6.2.2
                  </Text>{" "}
                  where applicable, you will register with all tax authorities
                  and render all tax returns to the appropriate authorities.
                </Text>
              </Box>
              ...
              <Text ml={2}>
                ...
                You acknowledge that we are not the producers of your products
                and we only provide you with a platform to sell them.
                Accordingly, you are not employed by Cutstruct or any of its
                affiliates, and the sale of your products on the Website is
                solely as independent person/entity.
              </Text>
              ...
              <Text ml={2}>
                ...
                We reserve the right to delete, unpublish, reject any listing
              ...
              <Text ml={2}>
                ...
                will not be an infringement to the intellectual property rights
              ...
              <Text ml={2}>
                ...
                Once your product is bought by a customer via the website, you
                are to make such product available to us for delivery to the
            ...
            <Box ml={3}>
              <Text ml={2}>
                ...
                Website shall be inclusive of Value Added Tax and other
                applicable taxes. Accordingly, you will have the responsibility
                to pay all taxes applicable to the sale of your products on the
                Website, and for the filing of returns of the taxes with the
              ...
              <Text ml={2}>
                ...
                You will indemnify and hold us harmless of any claim made
                against us by the tax authorities in respect of any statutory
                tax payable on your products or materials.
              </Text>
              <Text ml={2}>
                <Text as={"span"} color={"#F5862E"}>
                  7.3
            ...
            <Box ml={3}>
              ...
              <Text ml={2}>
                ...
                You may not engage in any misleading, inappropriate, or
                offensive behaviour. This applies to all your activities on the
                Website, including:
              </Text>
              ...
              <Box ml={3}>
                ...
                <Text ml={2}>
                  ...
                  Communication between you and Cutstruct or you and our
                  customers
                </Text>
              </Box>
              ...
              <Text ml={2}>
                ...
                condition of your product. Cutstruct reserves the right to
                request products be uploaded with their minimum number of Images
            ...
            <Text color={"#211F5C"} fontWeight={"bold"}>
              9. Prohibited Vendor Activities and Actions{" "}
            </Text>
            <Box ml={3}>
              <Text ml={2}>
                <Text as={"span"} color={"#F5862E"}>
              ...
              <Text ml={2}>
                ...
                attempts to divert Cutstruct users to any website to purchase
                same products advertised on the Website is prohibited.
                Specifically, any advertisement, marketing messages (special
                offers) or "calls to action" that lead, prompt, or encourage
                users of the Website to leave the Website are prohibited. This
                might include the use of emails, hyperlinks, URLs, or web
                addresses within any seller-generated confirmation email
                messages or any product/listing description fields.
              </Text>
              <Text ml={2}>
                <Text as={"span"} color={"#F5862E"}>
                  9.3
            ...
            <Box ml={3}>
              <Text ml={2}>
                ...
                All proceeds of any sale concluded by you on this Website shall
                be paid by the customer, directly to an escrow account
                maintained by our escrow partners.
              </Text>
              <Text ml={2}>
                <Text as={"span"} color={"#F5862E"}>
                  10.2
                </Text>{" "}
                Our escrow partners will only disburse any amount due to you
                after 2 (two) days of the Customer receiving the products,
                without initiating a dispute in respect of the quality or
                quantity received. Where the customer initiates dispute, then
                payment will only be disbursed 2 days after any such dispute is
                resolved. In the event that we are unable to resolve a dispute
                with the customer, and the customer initiates a return/refund
                procedure, then you will not be entitled to receive any payment.
                Also, if we determine that your account has been used to engage
                in fraud or other illegal activity, remittances and payments due
                to you might be withheld or forfeited.
              </Text>
              <Text ml={2}>
                <Text as={"span"} color={"#F5862E"}>
                  10.3
                </Text>{" "}
                You agree that a commission of 0.95% of the sales price is
                payable to us on all transactions carried out in respect of your
              ...
              <Text ml={2}>
                ...
                All payments to be disbursed to you shall be less our
                commission, as well as, any fees, charges, penalties, refunds
                and any other amounts that you owe to us in respect of any
                business whatsoever
              </Text>
              <Text ml={2}>
                <Text as={"span"} color={"#F5862E"}>
                ...
                of the goods purchased. The commission rate will be as
              ...
              <Box ml={3}>
                ...
                <Text ml={2}>
                  ...
                  you shall undertake such due diligence as is required for the
                ...
                <Text ml={2}>
                  ...
                  performance of your obligations hereunder. is transferred to
                  your computer or mobile device. It enables us to remember your
                  account log-in information, IP addresses, web traffic, number
                  of times you visit, date and time of visits.
                </Text>
              </Box>
              <br />
              ...
              <Box ml={3}>
                <Text>
                  You hereby agree to maintain an insurance policy with a
                  reputable insurance company acceptable to us in respect of
                  your liabilities under these Terms.
                </Text>
              </Box>
              <br />
              ...
              <Box ml={3}>
                ...
                <Box ml={3}>
                  <Text ml={2}>
                    ...
                    Under this license, except as and only to the extent any of
                    the following restrictions are prohibited by applicable law
                    or any of the restricted activities are permitted by the
                    licensing terms of any open-sourced components incorporated
                    into the Website, you may not:
                  </Text>
                  <Text ml={2}>
              ...
              <Box ml={3}>
                ...
                <Text ml={2}>
                  ...
                  the Website, the Cutstruct mark, logo, combined mark and logo
                  and other marks indicated on the Website (“the Cutstruct
                  IPR”).
                </Text>
                ...
                <Text ml={2}>
                  ...
                  re-publish, modify, alter, download, post, broadcast, transmit
                  or make any business use of the Cutstruct IPR. You must not
                  remove, alter or conceal or obscure any copyright, trademark,
                  service mark or other proprietary notices regarding the
                  Cutstruct IPR.
                </Text>
              </Box>
              <br />
              ...
              <Box ml={3}>
                <Text ml={2}>
                  ...
                  All complaints, inquiries and requests with respect to use of
                  the Website may be communicated to us via the following
                  channels:
                </Text>
                <Text ml={5}>
                  <Text as={"span"} color={"#F5862E"}>
              ...
              <Box ml={3}>
                <Text ml={2}>
                  You hereby agree to indemnify and hold Cutstruct harmless from
                  and against any claim, suit or proceedings brought against
                  Cutstruct arising from or in connection with your violation of
                  Intellectual Property or other rights of third parties in
              ...
              <Box ml={3}>
                <Text ml={2}>
                  ...
                  All information and documents concerning the conduct of
                  business pursuant to these Terms, including information
                  relating to business methods, procedures, policies and sales
                  information, is strictly confidential unless it is already in
                  the public domain. You shall not use Cutstruct's confidential
                  information for any purpose other than to perform your
                  obligations under this Agreement and you shall not disclose
                  Cutstruct's confidential information without our prior written
                  consent. complaint in order to address it, and your response
                  time will impact on how quickly we may be able to resolve your
                  complaint.
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
                  ...
                  You will be directly responsible to buyers for any misuse of
                  their personal data.
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
                  ...
                  result of the your handling of personal data obtained through
                  the Website, you shall indemnify Cutstruct in respect of same.
                </Text>
              </Box>
              <br />
              ...
              <Box ml={3}>
                <Text ml={2}>
                  ...
                  your complaints through the channels provided herein as soon
                  as you can so that we can attend to them.complaint.
                </Text>
                <Text ml={2}>
                  <Text as={"span"} color={"#F5862E"}>
                    19.2
              ...
              <Box ml={3}>
                ...
                <Text ml={2}>
                  ...
                  You may request termination of your account at any time by
                  sending an e-mail to that effect, in which event you:
                </Text>
                <Box ml={3}>
                  <Text ml={2}>
                    <Text as={"span"} color={"#F5862E"}>
                    ...
                    will be required to discontinue any further use of the
                    Website; and
                  </Text>
                  <Text ml={2}>
                    <Text as={"span"} color={"#F5862E"}>
                ...
                <Text ml={2}>
                  ...
                  granted hereunder forthe use of the Website, will
          ...
          <Box
            ...
            borderRadius={"50%"}
          >
            <Text textAlign={"center"} color={"white"} mt={3} ml={3}>
              <BsArrowDown fontSize={"32px"} />
            </Text>
          </Box>
        </ModalBody>
        <ModalFooter>
          <Button onClick={onClose} bg={"#F5862E"} color={"white"}>
            Done Reading
          </Button>
        </ModalFooter>
      </ModalContent>
